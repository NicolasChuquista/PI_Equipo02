...
### 2. Metodología
#### 2.1 Fuente de Datos
Los datos fueron descargados desde el portal oficial:
#### United States Environmental Protection Agency
Plataforma: Outdoor Air Quality Data

En particular, se utilizó la herramienta:
#### Download Daily Data
...
Agrupación por fecha para obtener el promedio diario de PM2.5 (considerando múltiples estaciones de monitoreo)
...
El modelo permitió ajustar una curva estacional suave que representa el comportamiento general del PM2.5, así como generar una predicción continua para el año 2024.
    ...
    <td><img width="200" src="[img/foto2.jpeg](https://github.com/NicolasChuquista/PI_Equipo02/blob/main/img/Flavio%20Rabanal_Multivariable.png?raw=true)"></td>
