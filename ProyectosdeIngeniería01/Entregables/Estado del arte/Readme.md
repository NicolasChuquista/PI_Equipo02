...
A continuación se presenta un análisis comparativo de los sistemas más relevantes del mercado y de la literatura académica en relación con el sistema SolarGrid propuesto:Sistema	Precio (USD)	MPPT	WiFi / App	Priorización cargas	Alertas SMS	Open source / contexto rural
