...
Para otorgar un sustento técnico a los rangos de proliferación, se utilizó el concepto de **Tiempo de Generación ($g$)**, que define el tiempo requerido para que una población bacteriana se duplique. La relación matemática empleada es:
...
<p align="center">
  <b>Tabla 2: Clasificación Final por Sinergia de Parámetros (Creación Propia)</b>
</p>
