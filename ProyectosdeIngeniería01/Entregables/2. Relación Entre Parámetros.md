...
Utilizando los datos experimentales de cinética bacteriana a 20°C extraídos de la literatura (2) y procesados mediante una regresión en Python, el modelo alcanzó un nivel de eficiencia del **93.99%** (**$R^2 = 0.9399$**).
...
| **Baja Proliferación** | Riesgo BAJO | 🟢 RIESGO MÍNIMO | Ambas condiciones son óptimas para evitar la proliferación bacteriana. |
  <br>
  <b>Tabla 2: Criterios (Creación Propia)</b>
</p>
